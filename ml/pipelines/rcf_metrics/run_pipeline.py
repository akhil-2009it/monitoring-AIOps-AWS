...
from ml.pipelines.rcf_metrics.pipeline import build_pipeline
...
def main():
    ...
    config = PipelineConfig(
        model_name="rcf-metrics",
        model_group_name="RCFMetricsModelGroup",
        environment=args.env, region=args.region,
        role_arn=args.role_arn, bucket=args.bucket,
        feature_group_name="monitoring-mlops-metric-features-v1",
        metric_gate={"f1": 0.70},
