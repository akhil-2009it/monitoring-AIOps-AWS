...
from ml.pipelines.iforest_logs.pipeline import build_pipeline
...
def main():
    ...
    config = PipelineConfig(
        model_name="iforest-logs",
        model_group_name="IForestLogsModelGroup",
        environment=args.env, region=args.region,
        role_arn=args.role_arn, bucket=args.bucket,
        feature_group_name="monitoring-mlops-log-features-v1",
        metric_gate={"precision_at_top1pct": 0.80},
